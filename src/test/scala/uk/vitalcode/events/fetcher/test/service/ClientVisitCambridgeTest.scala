...
class ClientVisitCambridgeTest extends FetcherTest {
    ...
    private def expectedEsDataDescription(): DataTable = {
        DataTableBuilder()
            .addRow(DataRowBuilder().setRowId("http://www.visitcambridge.org/whats-on/official-guided-tours-cambridge-college-tour-including-kings-college-p568001")
            ...
            .addRow(DataRowBuilder().setRowId("http://www.visitcambridge.org/whats-on/cambridge-thai-festival-p686901")
